...
var basic_food_chain = (function create_api() {
    ...
    function show_next_question() {
        ...
        document.getElementById( "question" ).innerHTML = top.game_logic.get_current_question_text( current_question_index );
        
        // get the details for the current question
        var images  = top.game_logic.get_current_question_images( current_question_index );
        var animals = top.game_logic.get_current_question_animals( current_question_index );
    ...
    function answer_clicked( click_event ) {
        ...
        if ( top.game_logic.validate_answer( current_question_index, answer ) ) {
            
            // TODO: show a happy face here.
