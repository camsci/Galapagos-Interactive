...
var index_data = {
	...
	flying_fish : {
		...
		habitat          : "Found in tropical and warm subtropical waters, flying fish spend the majority of their time close to the surface of the water. When under threat from predators, flying fish will propel themselves out of the water and glide for up to 100m.",
	...
	vampire_finch : {
		...
		food             : "The vampire finch has evolved an unusual diet, drinking the <b>blood of sea birds<\/b> such as the <b>blue-footed booby<\/b>.",
	...
	land_iguana : {
		...
		food             : "Land iguanas are primarily <b>herbivores<\/b>, feeding on low-growing plants and shrubs such as the <b>prickly pear cactus<\/b>, but some will also eat insects.",
	...
	green_sea_lettuce : {
		...
		food             : "Most types of algae get their energy from the same source that plants do: the sun. The sun's energy helps algae to turn dissolved carbon dioxide and water into oxygen and sugar, a process called <b>photosynthesis<\/b>. Like plants, this seaweed is a <b>producer<\/b>.",
	...
	plankton : {
		...
		food             : "Plankton is made up of both algae and animals. The algae gets energy from the sun in the same way as other algae and plants do (it is a <b>producer<\/b>).",
		predators        : "Plankton is eaten by lots of different animals, from the small (shrimps, corals, marine snails) to the medium (lobsters, <b>fish<\/b>, anemones) to the very large (whale sharks, whales)!",
